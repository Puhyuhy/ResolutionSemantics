...
\]
Since $I_X$ is absorbing, $\rho_X$ is a congruence; when $I_X$ is nonempty this
is the usual Rees congruence associated with an ideal \cite{Tichy1981}.  Every
base element remains a singleton class.  Outside the image of $A$ the quotient
has the singleton classes indexed by $N_X$, together with at most one
additional class represented by $I_X$.  Hence
\[
