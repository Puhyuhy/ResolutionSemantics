...
base and need not be a subalgebra of $F(D)$.  No claim is made that
finite-complement finiteness, congruence topologies, or factorial finite-state
synchronization are themselves new.
...
infinite-base criterion, and gives the discrete counterexample.
\Cref{sec:examples} gives one arithmetic instance of the criterion.
